import 'package:bic_android_web_support/model_class/hospital.dart';
import 'package:flutter/material.dart';

class FlutterDropdownSearch extends StatefulWidget {
  final TextEditingController? textController;
  final String? hintText;
  final List<HospitalHit>? items;
...
class _FlutterDropdownSearchState extends State<FlutterDropdownSearch> {
  ...
  List<HospitalHit> _filteredList=[];
  List<HospitalHit> _subFilteredList=[];
          ...
          onChanged: (val){
            setState(() {
              _filteredList = _subFilteredList.where((element) =>
                  element.walletAddress.toLowerCase().contains(widget.textController!.text.toLowerCase())).toList();
            });
          },
            ...
            itemBuilder: (context,index){
              return InkWell(
                onTap: (){
                  ...
                  widget.textController!.text=_filteredList[index].walletAddress;
                },
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0),
                  child: Text(_filteredList[index].walletAddress,
