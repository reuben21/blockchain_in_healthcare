...
class PharmacyStorageForm extends StatefulWidget {
  static const routeName = '/patientDetail';
  const PharmacyStorageForm({Key? key}) : super(key: key);

  @override
  _PharmacyStorageFormState createState() => _PharmacyStorageFormState();
}

class _PharmacyStorageFormState extends State<PharmacyStorageForm> {
