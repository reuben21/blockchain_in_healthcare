...
class DoctorChangeHospital extends StatefulWidget {
  ...
  const DoctorChangeHospital({
    required this.doctorWalletAddress,
    required this.oldHospitalAddress,
  });

  @override
  _DoctorChangeHospitalState createState() => _DoctorChangeHospitalState();
}

class _DoctorChangeHospitalState extends State<DoctorChangeHospital> {
