...
class HospitalAccessListPending extends StatefulWidget {
  static const routeName = '/hospital-access-list';

  @override
  _HospitalAccessListPendingState createState() => _HospitalAccessListPendingState();
}

class _HospitalAccessListPendingState extends State<HospitalAccessListPending> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: StreamBuilder<firestore.QuerySnapshot>(
          stream: users
              ?.doc(walletAddress)
              .collection("AccessControl").where("granted",isEqualTo: false)
              .limit(10)
              .snapshots(),
          builder:
